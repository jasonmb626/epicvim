return {
	...
	config = function()
		...
		local on_attach = function(client, bufnr)
			...
			keymap.set("n", "<leader>cp", vim.diagnostic.goto_prev, opts) -- jump to previous diagnostic in buffer

			opts.desc = "Go to next diagnostic"
			keymap.set("n", "]d", vim.diagnostic.goto_next, opts) -- jump to next diagnostic in buffer
			keymap.set("n", "<leader>cn", vim.diagnostic.goto_next, opts) -- jump to next diagnostic in buffer
